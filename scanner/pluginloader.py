from .plugins.CompileCMS.cmsmain import *
from .plugins.filescan.filescanmain import *
from .plugins.weakScan.weakscanmain import *
# 前端所循环的字典
# 每一个字典是一个算法
# 算法目录在plugins/下
# import 需要的算法
...
class pluginMain:
    def __init__(self):
        self.angelsword={
            ...
            "filescandict":{
                "后台目录扫描":folder_scan_fun,
                "页面查询":page_search_fun
            },
            "WeakScandict":{
                "SSH扫描":Weak_SSH_Scan,
                "FTP扫描":Weak_FTP_Scan
